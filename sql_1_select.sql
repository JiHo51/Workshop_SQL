...
FROM CITY WHERE COUNTRYCODE = "arm";
#
#
...
SELECT NAME FROM CITY WHERE COUNTRYCODE = "TJK" OR COUNTRYCODE = "MRT" OR COUNTRYCODE = "AND" OR COUNTRYCODE = "PNG" OR COUNTRYCODE = "SJM";
#
#
